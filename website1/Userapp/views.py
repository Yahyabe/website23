...
from Userapp.forms import SingUpForm, UserUpdateForm, ProfileUpdateForm
...
def user_password(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(
                request, 'Your password was successfully updates'
            )
            return redirect('userprofile')
        else:
            messages.error(
                request, 'Place correct the error below.<br>' + str(form.errors))
