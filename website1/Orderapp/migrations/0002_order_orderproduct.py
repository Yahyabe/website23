# Generated by Django 3.1.5 on 2021-04-14 06:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Product', '0005_auto_20210321_1523'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Preparing', 'Preparing'), ('Onshiping', 'Onshiping'), ('Complated', 'Complated'), ('Cancelled', 'Cancelled')], default='New', max_length=20)),
