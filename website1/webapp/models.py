...
class Setting(models.Model):
    ...
    smptpserver = models.CharField(max_length=100)
    smtpemail = models.EmailField(blank=True, null=True, max_length=60)
    smptpassword = models.CharField(blank=True, max_length=60)
...
class ContactForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'message': TextInput(attrs={'class': 'input', 'placeholder': 'Write yoour messages'}),
        }